        ...
        <form onSubmit={handleSubmit} className="modal-body form-grid">
          ...
          <div className="form-group span-2">
            ...
            <div className="image-presets-row">
              {/* Picker thumbnails — no CSS constrains .preset-thumb's rendered
                  size (pre-existing, separate from this fix), but requesting
                  120px instead of the stored 600px preset URL still cuts the
                  transferred bytes for this picker ~20x regardless of how big
                  they're ultimately displayed. */}
              {sampleImages.map((img, i) => (
                <img
                  key={i}
                  src={sizedImageUrl(img, 120)}
                  alt="preset"
                  loading="lazy"
                  decoding="async"
